...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>{{$filiere->nomf}}</td>
      <td><a class="btn btn-primary" href="{{route('Filiere.edit',$filiere->id)}}">Modifier Entreprise</a>
        </td>
        <td>
...
<a class="btn btn-success" href="{{route('Filiere.create')}}">Ajouter Entreprise</a>
</body>
</html>
